      ...
      <section>
        <div>
          <div className='text-center mx-11'>
            ...
            <p className='text-amber-900 box-content leading-normal '>
      ...
      <section>
        <div className='grid grid-cols-1 p-4 m-9 sm:grid-cols-2 box-content sm:gap-10 '>
          <div className='sm:col-span-1 text-left box-content'>
            ...
            <p className='text-greyText box-content leading-normal text-left'>
              BUNKUA specializes in turning raw, unstructured data into a
              powerful asset. We apply rigorous methodologies in data analysis,
              machine learning, and artificial intelligence to uncover hidden
              patterns and predict future trends. Our solutions are designed not
              just to analyze, but to inform, empowering businesses to make
              smarter, faster decisions.
              <br />
              <br /> We believe that true digital transformation occurs when
              technology seamlessly integrates with business strategy, creating
              systems that are intuitive, efficient, and deeply insightful. Our
              team works closely with clients to build bespoke AI models and
              implement robust data infrastructures that drive sustainable
              growth.
            </p>
          </div>
          ...
          <div className='grid grid-cols-1 gap-6 sm:grid sm:grid-cols-3  sm:gap-6 m-11   '>
            ...
            <div className='border border-b-gray-500 shadow-md rounded-xl p-6 flex flex-col items-center justify-between h-full text-center text-balance'>
              ...
              <p className='text-gray-600 text-sm mb-4 leading-relaxed text-center'>
                ...
                existing systems to automate tasks, predict trends, and optimize
                operations.
              </p>
              <a
                href='#'
          ...
          <div className='grid grid-cols-1 gap-6 sm:grid sm:grid-cols-3  sm:gap-6 m-11   '>
            ...
            <div className='border border-b-gray-500 shadow-md rounded-xl p-6 flex flex-col items-center justify-between h-full text-center text-balance'>
              <p className='text-gray-600 text-sm mb-4 leading-relaxed text-center'>
                ...
                significant cost savings and improved decision-making across our
                departments.
              </p>
              <a
                href='#'
            ...
            <div className='border border-b-gray-500 shadow-md rounded-xl p-6 flex flex-col items-center justify-between h-full text-center text-balance'>
              <p className='text-gray-600 text-sm mb-4 leading-relaxed text-center'>
                Our growth accelerated dramatically after implementing BUNKUA's
                strategic recommendations. A true partner in innovation.
              </p>
              <a
                href='#'
                className='inline-flex items-center text-green-600 hover:underline mt-auto'
